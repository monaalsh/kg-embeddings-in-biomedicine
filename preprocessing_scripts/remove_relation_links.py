...
sub_links = [(item[0],item[1],item[2]) for item in graph if 'has_disease_phenotype' in mapping_dict[int(item[2])]]
...
edgelist = data_dir+ 'edgelist_has_disease_phenotype_free.txt'
